...
superficially high composite score. \HEPI{} also does not specify a
deployment-decision threshold; we report it as a diagnostic decomposition of
where a design's cost falls, not as a scalar a reader should threshold
against to certify deployment readiness.
